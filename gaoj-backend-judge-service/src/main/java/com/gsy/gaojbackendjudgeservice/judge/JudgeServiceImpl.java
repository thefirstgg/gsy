...
import com.gsy.gaojbackendjudgeservice.judge.codesandbox.CodeSandboxFactory;
import com.gsy.gaojbackendjudgeservice.judge.codesandbox.CodeSandboxProxy;
import com.gsy.gaojbackendjudgeservice.judge.strategy.JudgeContext;
...
public class JudgeServiceImpl implements JudgeService {
    ...
    public QuestionSubmit doJudge(long questionSubmitId) {
        ...
        if(!update)
        {
            throw new BusinessException(ErrorCode.SUCCESS,"题目状态更新错误");
        }
